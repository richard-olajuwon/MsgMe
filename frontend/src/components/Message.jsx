                        ...
                        m.senderId === myInfo.id ? <div key={index} ref={scrollRef} className="my-message">
                            <div className="image-message">
                                <div className="my-text">
                                    <p className='message-text my'>{m.message.text === '' ? <img src={`${m.message.image}`} alt='' /> : m.message.text}</p>
                                    {
                            ...
                            <div className="image-message-time">
                                {/* <img src={`${currentfriend.image}`} alt="" className=''/> */}
                                <div className="message-time">
                                    <div className="fd-text">
                                        <p className='message-text fd'>{m.message.text === '' ? <img src={`${m.message.image}`} alt='' /> : m.message.text}</p>
                                    </div>
                                    <div className="time">
                                        {moment(m.createdAt).startOf('mini').fromNow()}
                                    </div>
